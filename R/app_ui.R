      ...
      sidebarLayout(
        sidebarPanel(
          ...
          fluidPage(
            ...
            column(width = 4,
                   align = 'right',
              actionButton(inputId = "go_basic",
                                label = "Basic steps",
                                icon = icon("house"),
                                onclick ="window.open('https://hadexversum.github.io/HRaDeX/articles/basic_steps.html')"),
              br(),
              br(),
          ...
          collapsible_card(
            ...
            p("Besides that, there is an additional class defined by the rule of thumb: `very slow` - almost no exchange (black). For more information see the documentation and help.  "),
            div(
